<html>
	<head>
		<title>Welcome to BugQuery</title>
		<meta charset="utf-8">
	...
	<body>
		<div class = "bugquery-header">
			<div class = "wrapper">
				<ul>
					<li>
						<a id="bugquery-icon" href="index.jsp"> <svg
					...
					<li style="float: right; margin: 0"><a class="button" href="https://github.com/TechnionYP5777/Bugquery">BugQuery on GitHub</a></li>
				</ul>
			</div>
		</div>
		<div class = "wrapper">
			<h1>Welcome to BugQuery</h1>
			<p>BugQuery is a search engine for stack traces. It helps programmers solve bugs in their code in a quick and efficient way, using an index of questions and answers extracted from dedicated web services (like StackOverflow). BugQuery includes, along with this index, a website and a plug-in for Eclipse.</p>
		</div>
		<div class = "bugquery-footer">
			<div class = "wrapper">
				<p>© 2016 BugQuery.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href = "index.jsp">Home</a>&nbsp;-&nbsp;<a href="guide.html">User Guide</a>&nbsp;-&nbsp;<a href="submit.html">Submit Your Trace</a>&nbsp;-&nbsp;<a href="https://github.com/TechnionYP5777/Bugquery">BugQuery on GitHub</a> </p>
			</div>
		</div>
	</body>
</html>
