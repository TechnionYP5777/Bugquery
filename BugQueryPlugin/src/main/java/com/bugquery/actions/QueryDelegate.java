 ...
 *
 * <p>
 * All attributes are default in the the current implementation, This paragraph
 * should be erased as the class evolves
 *
 * <p>
 * Extended class {@link * JavaLaunchDelegate}, provides default values for a
 * run/debug on Java.
 *
